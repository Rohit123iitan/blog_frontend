      ...
      <div class="col-md-3 sticky" style="margin-right: 10px;">
        <div class="imp-link">
          <div class="card" style="width: 18rem;">
            <img src="../assets/profile_img.jpg" alt="proflie_img" class="card-img-top " style="border-radius:50%;padding: 10%;">
            <div class="card-body">
              <h5 class="card-title text-center">profile name</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk
                of the card's content.</p>
            </div>
            <button type="button" style="display: inline-block;" class="btn btn-primary " data-bs-toggle="modal"
